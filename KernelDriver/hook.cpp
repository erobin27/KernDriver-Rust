...
bool nullhook::call_kernel_function(void* kernel_function_address)
{
	...
	//\x48\xC7\xC2\x00\x00\x00\x00\x48\xBF\
	
	//xFF\xFF\xFF\xFF\xFF\xFF\x00\x00

	//\x48\x0F\x44\xD7\xFF\xE2


	//"\x39\xC0\x48\xBF\xAA\xAA\xAA\xAA\x00\x00\x00\x00\x48\x0F\x44\xD7\xFF\xE2"


	//mov eax, 0
	//mov rdi,....
	//BYTE shell_code[] = { 0x48, 0xC7, 0xC2, 0x00, 0x00, 0x00, 0x00, 0x48, 0xBF };
	BYTE shell_code[] = { 0x48, 0xBF};
	//BYTE shell_code[] = { 0x48, 0xB8 };

	//...
	//cmovz rdx, rdi
	//jmp rdx
	BYTE shell_code_end[] = {0x48, 0x39, 0xF7, 0xFF, 0xE7};
